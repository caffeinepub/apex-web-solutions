...
export class Backend implements backendInterface {
    ...
    async getContactLead(arg0: bigint): Promise<ContactLead> {
        if (this.processError) {
            try {
                const result = await this.actor.getContactLead(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitContactLead(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitContactLead(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
